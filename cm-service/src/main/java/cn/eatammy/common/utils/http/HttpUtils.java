package cn.eatammy.common.utils.http;
...
public class HttpUtils {
     ...
     */
    public static void generalUserSession(HttpSession session, UserDetail userBean, String token, int timeout){
        session.setAttribute(token, userBean);
