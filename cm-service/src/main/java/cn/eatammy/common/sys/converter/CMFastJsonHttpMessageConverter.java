package cn.eatammy.common.sys.converter;
 ...
 * json转化器
 */
public class CMFastJsonHttpMessageConverter<T> extends AbstractHttpMessageConverter<T> {
    public static final Charset UTF8 = Charset.forName("UTF-8");
    private Charset charset;
    private SerializerFeature[] features;

    public CMFastJsonHttpMessageConverter() {
